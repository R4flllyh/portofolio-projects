        ...
        <div class="space-y-8" ref="contactInfo">
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <a href="mailto:rafly@example.com" class="text-headline hover:text-button transition-colors duration-300 font-medium">
                    rafly@example.com
                  </a>
                </div>
              </div>
              ...
              <div class="flex items-center space-x-4 group">
                ...
                <div>
                  ...
                  <a href="tel:+6281234567890" class="text-headline hover:text-button transition-colors duration-300 font-medium">
                    +62 812-3456-7890
                  </a>
                </div>
              </div>
          ...
          <div class="bg-gray-800/40 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50">
            ...
            <div class="grid grid-cols-2 gap-4">
              <!-- GitHub -->
              <a href="https://github.com/rafly" target="_blank" class="group flex items-center space-x-3 p-4 bg-gray-700/30 rounded-xl hover:bg-gray-700/50 transition-all duration-300 hover:scale-105">
              ...
              <!-- LinkedIn -->
              <a href="https://linkedin.com/in/rafly" target="_blank" class="group flex items-center space-x-3 p-4 bg-blue-600/20 rounded-xl hover:bg-blue-600/30 transition-all duration-300 hover:scale-105">
              ...
              <!-- Instagram -->
              <a href="https://instagram.com/rafly" target="_blank" class="group flex items-center space-x-3 p-4 bg-pink-600/20 rounded-xl hover:bg-pink-600/30 transition-all duration-300 hover:scale-105">
              ...
              <!-- WhatsApp -->
              <a href="https://wa.me/6281234567890" target="_blank" class="group flex items-center space-x-3 p-4 bg-green-600/20 rounded-xl hover:bg-green-600/30 transition-all duration-300 hover:scale-105">
